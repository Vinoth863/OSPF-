...
# DEFINITION
OSPF is a link-state routing protocol used in IP networks to dynamically exchange routing information between routers. It calculates the shortest path to each network using Dijkstra’s algorithm and updates routes efficiently when network changes occur.
